...
export const quests: Quest[] = [
  {
    id: 1,
    get title() { return getQuestData(1).title; },
    point: { x: 2.5884740352630615, z: 6.506937026977539 },
    spawn_point: {
      x: -3.9238533973693848,
      z: -13.887053489685059,
    },
    get riddle() { return getQuestData(1).riddle; },
    get successMessage() { return getQuestData(1).successMessage; },
    status: "locked",
    trigger: "phonecall",
    get caller() { return getQuestData(1).caller; },
  },
  {
    id: 2,
    get title() { return getQuestData(2).title; },
    ...
    get riddle() { return getQuestData(2).riddle; },
    get successMessage() { return getQuestData(2).successMessage; },
    status: "locked",
    get caller() { return getQuestData(2).caller; },
    trigger: "direct",
  },
  {
    id: 3,
    get title() { return getQuestData(3).title; },
    spawn_point: { x: -44.017337799072266, z: 37.83137512207031 },
    point: { x: -49.462501525878906, z: 17.996505737304688 },
    get riddle() { return getQuestData(3).riddle; },
    get successMessage() { return getQuestData(3).successMessage; },
    status: "locked",
    get caller() { return getQuestData(3).caller; },
    trigger: "phonecall",
  },
  {
    id: 4,
    get title() { return getQuestData(4).title; },
    ...
    get riddle() { return getQuestData(4).riddle; },
    get successMessage() { return getQuestData(4).successMessage; },
    status: "locked",
    get caller() { return getQuestData(4).caller; },
    trigger: "direct",
  },
  {
    id: 5,
    get title() { return getQuestData(5).title; },
    spawn_point: {
      x: 20.30816078186035,
      z: -29.072660446166992,
    },
    point: { x: 3.4120869636535645, z: -27.783315658569336 },
    get riddle() { return getQuestData(5).riddle; },
    get successMessage() { return getQuestData(5).successMessage; },
    status: "locked",
    get caller() { return getQuestData(5).caller; },
    trigger: "direct",
  },
  {
    id: 6,
